...
const ServiceAdvertise = () => {
  return (
    <div className="bg-[#002F76] p-8 md:p-14 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 text-white">
      <div className="flex flex-col justify-center items-center">
        <MdOutlineEventAvailable className="text-3xl md:text-6xl" />
        <h1 className="text-sm md:text-2xl font-semibold mt-5 text-center">
