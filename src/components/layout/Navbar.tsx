...
const navigation = [
  { name: "Meeting Rooms", href: "#", current: true },
...
const Navbar: React.FC = () => (
  <Disclosure as="nav" className="bg-[#002F76]">
      ...
      <div className="relative flex h-16 items-center justify-between">
        ...
        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          <div className="flex shrink-0 items-center">
            <h1 className="text-white font-bold text-2xl">Meeting.com</h1>
          </div>
        </div>
        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          <div className="hidden sm:ml-6 sm:block">
            <div className="flex space-x-4 justify-centen items-center">
              ...
              <Button className="text-[#002F76] font-semibold">Register</Button>
              <Button className="text-[#002F76] font-semibold">Login</Button>
            </div>
          </div>
          {/* <button
            type="button"
        ...
        {navigation.map((item) => (
          <DisclosureButton
            ...
            className={classNames(
              item.current
                ? "bg-[#002F76] text-white"
                : "text-gray-300 hover:text-[#44FD60] hover:text-white",
