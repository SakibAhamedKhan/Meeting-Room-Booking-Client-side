...
const CustomerProfile = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="h-6 bg-gray-300 rounded-md w-64 animate-pulse"></div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="h-6 bg-gray-300 rounded-md w-40 animate-pulse"></div>
                  </div>
                </div>
      ...
      <Card>
        <Calendar fullscreen={false}  onPanelChange={onPanelChange} className="h-full"/>
      </Card>
    </div>
  );
};
